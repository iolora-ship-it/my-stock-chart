...
with st.sidebar.expander("📏 期間の使い分け方"):
    st.markdown(
        "- **1日・3日**: その日の値動きに近い見方です。「👀 注目」バッジ（出来高急増）が出た直後に、"
        "実際どれくらい動いたかをすぐ確認したいときに向いています。\n"
        "- **5日**: チャートの5日線と同じ幅です。直近の初動をそのまま追いたいときに。\n"
        "- **10日（初期設定）**: 5日線と25日線の中間くらいの幅です。ノイズをある程度均しつつ、"
        "新しく動き出したセクターや銘柄の初動を拾えるバランスの良い期間として初期設定にしています。\n"
        "- **20日**: チャートの25日線とほぼ同じ幅です。「📈 トレンド確立」バッジ"
        "（MA5>MA25>MA75の並び）はこの25日線を基準に判定しているため、バッジが示すトレンドが"
        "実際の騰落率にも表れているかを確認するのに向いています。\n"
        "- **60日**: チャートの75日線とほぼ同じ幅です。数ヶ月単位で本当に定着したトレンドかどうかの"
        "確認に向いています（短期の値動きには反応しにくくなります）。\n"
        "- **半年・1年**: 「🏔 52週高値圏」バッジが示す1年を通じた強さを、実際の騰落率でも"
        "確認したいときに。\n\n"
        "なお、各バッジ（トレンド確立度・52週高値圏・出来高急増など）自体はこの期間設定に関係なく、"
        "それぞれ固定の期間（5・25・75日線、過去52週間など）で判定しています。"
    )
